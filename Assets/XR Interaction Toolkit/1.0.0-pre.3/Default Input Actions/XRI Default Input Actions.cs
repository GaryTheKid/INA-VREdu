...
//     version 1.2.0
//     from Assets/XR Interaction Toolkit/1.0.0-pre.3/Default Input Actions/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""InstantiatePart"",
                    ""type"": ""Button"",
                    ""id"": ""9ccadaf3-4108-4fa3-8383-ab4b9adfa12f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""FireRotors"",
                    ""type"": ""Button"",
                    ""id"": ""a0daf38a-f8f2-41b8-9548-5c99363c9729"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""993d9b41-d44f-417a-92a0-29e062ca4464"",
                    ""path"": ""<XRController>{RightHand}/primary2DAxis"",
                    ""interactions"": """",
                    ""processors"": ""StickDeadzone"",
                    ""groups"": ""Continuous Move"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0d30004a-dfc0-43b3-83bc-0b4a30700da1"",
                    ""path"": ""<XRController>{RightHand}/secondaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""InstantiatePart"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""422e04c7-95d1-47b6-97bf-015d2e186f8b"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHand_InstantiatePart = m_XRIRightHand.FindAction("InstantiatePart", throwIfNotFound: true);
        m_XRIRightHand_FireRotors = m_XRIRightHand.FindAction("FireRotors", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRIRightHand_InstantiatePart;
    private readonly InputAction m_XRIRightHand_FireRotors;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @InstantiatePart => m_Wrapper.m_XRIRightHand_InstantiatePart;
        public InputAction @FireRotors => m_Wrapper.m_XRIRightHand_FireRotors;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @InstantiatePart.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnInstantiatePart;
                @InstantiatePart.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnInstantiatePart;
                @InstantiatePart.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnInstantiatePart;
                @FireRotors.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnFireRotors;
                @FireRotors.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnFireRotors;
                @FireRotors.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnFireRotors;
            }
            ...
            if (instance != null)
            {
                ...
                @TranslateAnchor.performed += instance.OnTranslateAnchor;
                @TranslateAnchor.canceled += instance.OnTranslateAnchor;
                @InstantiatePart.started += instance.OnInstantiatePart;
                @InstantiatePart.performed += instance.OnInstantiatePart;
                @InstantiatePart.canceled += instance.OnInstantiatePart;
                @FireRotors.started += instance.OnFireRotors;
                @FireRotors.performed += instance.OnFireRotors;
                @FireRotors.canceled += instance.OnFireRotors;
            }
        }
    }
    ...
    public interface IXRIRightHandActions
    {
        ...
        void OnRotateAnchor(InputAction.CallbackContext context);
        void OnTranslateAnchor(InputAction.CallbackContext context);
        void OnInstantiatePart(InputAction.CallbackContext context);
        void OnFireRotors(InputAction.CallbackContext context);
    }
}
